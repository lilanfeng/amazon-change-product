...
public class SystemUtil {
    ...
    public static final String CONFIG_HOME = USER_HOME + File.separator + ".amazonChange";

    /**
     * log file dir
     */
    public final static String LOG_DIR = USER_HOME + File.separator + ".amazonChange" + File.separator + "logs" + File.separator;
